<?php $__env->startSection('title', 'Cadastro das instituições'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="nome" id="nome" placeholder="Nome da instituição">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="sigla" id="sigla" placeholder="Sigla da instituição">
                            </div>
                        </div>                        
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="url_site" id="url_site" placeholder="https://..">
                            </div>
                        </div>
                    </div>
                </fieldset>             
...
$(document).ready(function(){
    ...
    $(document).on('click','.salvar_btn',function(e){
        ...
        $.ajax({
            url: '/admin/institucionais/store',
            type: 'POST',
            dataType: 'json',
            data: data,
            cache: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/datacenter/institucional/create.blade.php ENDPATH**/ ?>