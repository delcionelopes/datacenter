<?php $__env->startSection('title', 'PRODAP - Equipamentos'); ?>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditSenhaIndividual" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_senhaindividual_btn"><img id="imgeditindividual" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5">
    <input type="hidden" id="grupoid" value="<?php echo e($grupo->id); ?>">
    <div id="success_message"></div>        
            <section class="border p-4 mb-4 d-flex align-items-left">
            <form action="<?php echo e(route('datacenteradmin.equipamento.equipamento.index',['id' => $grupo->id, 'color'=>$color])); ?>" class="form-search" method="GET">
                    <div class="col-sm-12">
                        ...
                        <nav class="navbar navbar-expand-md navbar-light bg-light">
                            ...
                            <button type="button" data-grupo="<?php echo e($grupo->id); ?>" data-color="<?php echo e($color); ?>" class="AddEquipamento_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none;white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro">
   ...
   <section class="content border p-4 mb-4 d-flex">
        <div class="container-fluid">
            ...
            <thead class="bg-<?php echo e($color); ?>" style="color: white">
                    <tr>                        
                        <th scope="col">EQUIPAMENTO(s) DE <?php echo e($grupo->sigla); ?></th>
                ...
                <tbody id="lista_equipamentos">
                    ...
                    <tr id="equipamento<?php echo e($equipamento->idequipamento_rede); ?>" data-toggle="tooltip" title="<?php echo e($equipamento->descricao); ?>">
                        ...
                        <td id="senha<?php echo e($equipamento->idequipamento_rede); ?>">
                            ...
                            <?php else: ?>
                            <?php if((!$equipamento->users()->count())&&((auth()->user()->admin==true)&&($equipamento->setor_idsetor==auth()->user()->setor_id))): ?>
                                 <button id="botaosenha<?php echo e($equipamento->idequipamento_rede); ?>" type="button" data-id="<?php echo e($equipamento->idequipamento_rede); ?>" data-nome="<?php echo e($equipamento->nome); ?>" data-opt="1" data-admin="<?php echo e(auth()->user()->admin); ?>" data-useridsetor="<?php echo e(auth()->user()->setor_id); ?>" data-idsetor="<?php echo e($equipamento->setor_idsetor); ?>" data-setor="<?php echo e($equipamento->setor->sigla); ?>" class="senhabloqueada_btn fas fa-lock-open" style="background: transparent; color: green; border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Primeira autorização"></button>
                            <?php else: ?>     
                            <?php if($equipamento->users()->count()): ?>                           
                            <?php $__currentLoopData = $equipamento->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($user->id == auth()->user()->id): ?>
                                  <button id="botaosenha<?php echo e($equipamento->idequipamento_rede); ?>" type="button" data-id="<?php echo e($equipamento->idequipamento_rede); ?>" data-nome="<?php echo e($equipamento->nome); ?>" data-opt="1" data-admin="<?php echo e(auth()->user()->admin); ?>" data-useridsetor="<?php echo e(auth()->user()->setor_id); ?>" data-idsetor="<?php echo e($equipamento->setor_idsetor); ?>" data-setor="<?php echo e($equipamento->setor->sigla); ?>" class="senhabloqueada_btn fas fa-lock-open" style="background: transparent; color: green; border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($equipamento->users->implode('name','<br>')); ?>"></button>
                                  <?php break; ?>
                                  <?php elseif($loop->last): ?>
                                  <button id="botaosenha<?php echo e($equipamento->idequipamento_rede); ?>" type="button" data-id="<?php echo e($equipamento->idequipamento_rede); ?>" data-nome="<?php echo e($equipamento->nome); ?>" data-opt="0" data-admin="<?php echo e(auth()->user()->admin); ?>" data-useridsetor="<?php echo e(auth()->user()->setor_id); ?>" data-idsetor="<?php echo e($equipamento->setor_idsetor); ?>" data-setor="<?php echo e($equipamento->setor->sigla); ?>" class="senhabloqueada_btn fas fa-lock" style="background: transparent; color: red; border: none;white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($equipamento->users->implode('name','<br>')); ?>"></button>
                                  <?php endif; ?>                                                        
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                            
                            <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <td>
                            <div class="btn-group">
                                <button type="button" data-grupo="<?php echo e($grupo->id); ?>" data-id="<?php echo e($equipamento->idequipamento_rede); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-useridsetor="<?php echo e(auth()->user()->setor_id); ?>" data-idsetor="<?php echo e($equipamento->setor_idsetor); ?>" data-setor="<?php echo e($equipamento->setor->sigla); ?>" class="edit_equipamento_btn fas fa-edit" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar"></button>
                                <button type="button" data-id="<?php echo e($equipamento->idequipamento_rede); ?>" data-nome="<?php echo e($equipamento->nome); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-useridsetor="<?php echo e(auth()->user()->setor_id); ?>" data-idsetor="<?php echo e($equipamento->setor_idsetor); ?>" data-setor="<?php echo e($equipamento->setor->sigla); ?>" class="delete_equipamento_btn fas fa-trash" style="background: transparent;border: none;white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir"></button>
                            </div>
                        </td>
                    </tr>
...
$(document).ready(function(){
        ...
        $(document).on('click','.edit_equipamento_btn',function(e){
           ...
           location.replace('/datacenteradmin/equipamento/edit-equipamento/'+id+'/'+grupoid+'/'+color); 
        });
    ...
    $(document).on('click','.AddEquipamento_btn',function(e){
        ...
        var grupoid = $(this).data("grupo");
        var color = $(this).data("color");
        location.replace('/datacenteradmin/equipamento/create-equipamento/'+grupoid+'/'+color);
    });

    $(document).on('click','.voltarmenu_btn',function(e){
        e.preventDefault();  
        var color = $(this).data("color");
        location.replace('/datacenteradmin/grupo/index/'+color);
        });
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/datacenter/equipamento/index.blade.php ENDPATH**/ ?>