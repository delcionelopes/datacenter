        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-<?php echo e($color); ?> add_area_conhecimento"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    <button type="button" class="btn btn-<?php echo e($color); ?> update_area_conhecimento"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5">
    <div id="success_message"></div>
            <section class="border p-4 mb-4 d-flex align-items-left">
                <form action="<?php echo e(route('datacenteradmin.areaconhecimento.areaconhecimento.index',['color'=>$color])); ?>" class="form-search" method="GET">
                    <div class="col-sm-12">
        ...
        <div class="container-fluid">
            ...
            <thead class="bg-<?php echo e($color); ?>" style="color: white">
                ...
                <tbody id="lista_area_conhecimento">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $areas_conhecimento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area_conhecimento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr id="area<?php echo e($area_conhecimento->id); ?>">
                        <th scope="row"><?php echo e($area_conhecimento->descricao); ?></th>                        
                        <td>
                            <div class="btn-group">
                                <button data-id="<?php echo e($area_conhecimento->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-descricao="<?php echo e($area_conhecimento->descricao); ?>" class="edit_area_conhecimento fas fa-edit" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar ÁREA"></button>
                                <button data-id="<?php echo e($area_conhecimento->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-descricao="<?php echo e($area_conhecimento->descricao); ?>" class="delete_area_conhecimento_btn fas fa-trash" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir ÁREA"></button>
                            </div>
                        </td>
                    </tr>
            ...
            <?php echo e($areas_conhecimento->links()); ?>      
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/area_conhecimento/index.blade.php ENDPATH**/ ?>