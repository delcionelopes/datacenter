    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary add_perfil"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="editPerfilModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" class="btn btn-primary update_perfil"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce" id="ListAuthorizationModal" tabindex="-1" role="dialog" aria-labelledby="listtitleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" class="btn btn-primary update_listauthorization"><img id="imglist" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Confirmar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5">   
    ...
    <form action="<?php echo e(route('datacenteradmin.perfil.index')); ?>" class="form-search" method="GET">
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $perfis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perfil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>   
                            <tr id="perfil<?php echo e($perfil->id); ?>">                                
                                <th scope="row"><?php echo e($perfil->nome); ?></th>                                
                                <td>
                                        <div class="btn-group">                                           
                                            <button type="button" data-id="<?php echo e($perfil->id); ?>" data-nome="<?php echo e($perfil->nome); ?>" class="list_authorizations_btn" style="background:transparent;border:none;"><i id="ico_list<?php echo e($perfil->id); ?>" class="fas fa-list"></i><img id="img_list<?php echo e($perfil->id); ?>" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"></button>
                                        </div>    
                                </td>
                                <td>                                    
                                        <div class="btn-group">                                           
                                            <button type="button" data-id="<?php echo e($perfil->id); ?>" data-nomeperfil="<?php echo e($perfil->nome); ?>" class="edit_perfil fas fa-edit" style="background:transparent;border:none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar"></button>
                                            <button type="button" data-id="<?php echo e($perfil->id); ?>" data-nomeperfil="<?php echo e($perfil->nome); ?>" class="delete_perfil_btn fas fa-trash" style="background:transparent;border:none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir"></button>
                                        </div>                                    
                                </td>
                            </tr>  
                ...
                success: function(response){
                    if(response.status==400){
                        ...
                        //atualizando a linha na tabela html                        
                            var link = "";
                            var linha = ""; 
                                link = "<?php echo e(asset('')); ?>"+"storage/ajax-loader.gif";
            ...
            $.ajax({
                ...
                success: function(response){
                    if(response.status==400){
                        ...
                        var link = "<?php echo e(asset('')); ?>"+"storage/ajax-loader.gif";
                        var tupla = "";
                        var linha0 = "";
                        var linha1 = "";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/caos/perfil/index.blade.php ENDPATH**/ ?>