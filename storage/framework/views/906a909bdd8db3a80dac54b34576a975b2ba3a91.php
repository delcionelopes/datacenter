    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                <form id="addform" name="addform" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="cluster form-control" value="<?php echo e($cluster->nome_cluster); ?>">
                    </div>
                    </div>
                    </div>
                    <div class="row">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_host"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditHostModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_host"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
            </div>
        </div>
    </div>
</div>
   ...
   <div class="modal fade animate__animated animate__bounce animate__faster" id="AddSenhaHost" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_senhahost_btn"><img id="imgaddsenha" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditSenhaHost" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_senhahost_btn"><img id="imgeditsenha" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5">
    <div id="success_message"></div>   
            <section class="border p-4 mb-4 d-flex align-items-left">
                <form action="<?php echo e(route('datacenteradmin.host.host.index',['id'=>$id,'color'=>$color])); ?>" class="form-search" method="GET">
                    <div class="col-sm-12">
                        ...
                        <nav class="navbar navbar-expand-md navbar-light bg-light">
                            ...
                            <button type="button" data-id="<?php echo e($id); ?>" class="AddHostModal_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro">
           ...
           <div class="container-fluid">
            ...
            <thead class="bg-<?php echo e($color); ?>" style="color: white">
                ...
                <tr id="novo" style="display:none;"></tr>
                    ...
                    <tr id="host<?php echo e($host->id); ?>" style="white-space: nowrap;" data-toggle="tooltip" title="IP:<?php echo e($host->ip); ?>">
                        <th scope="row"><?php echo e($host->datacenter); ?></th>
                         <td id="senha<?php echo e($host->id); ?>">
                            <?php if(!$host->senha): ?>
                            <button id="botaosenha<?php echo e($host->id); ?>" type="button" data-id="<?php echo e($host->id); ?>" data-nomehost="<?php echo e($host->datacenter); ?>" data-clusterip="<?php echo e($host->cluster); ?>/<?php echo e($host->ip); ?>" class="cadsenha_btn fas fa-folder" style="background: transparent; color: orange; border: none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Registrar senha e dar<br>permissões de visualização"></button>
                            <?php else: ?>
                            <?php if($host->users()->count()): ?>                           
                            <?php $__currentLoopData = $host->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <button id="botaosenha<?php echo e($host->id); ?>" type="button" data-id="<?php echo e($host->id); ?>" data-nomehost="<?php echo e($host->datacenter); ?>" data-clusterip="<?php echo e($host->cluster); ?>/<?php echo e($host->ip); ?>" data-opt="1" class="senhabloqueada_btn fas fa-lock-open" style="background: transparent; color: green; border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($host->users->implode('name','<br>')); ?>"></button>
                                  <?php break; ?>
                                  <?php elseif($loop->last): ?>
                                  <button id="botaosenha<?php echo e($host->id); ?>" type="button" data-id="<?php echo e($host->id); ?>" data-nomehost="<?php echo e($host->datacenter); ?>" data-clusterip="<?php echo e($host->cluster); ?>/<?php echo e($host->ip); ?>" data-opt="0" class="senhabloqueada_btn fas fa-lock" style="background: transparent; color: red; border: none;white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($host->users->implode('name','<br>')); ?>"></button>
                                  <?php endif; ?>                                                        
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                            
                            <?php endif; ?>
                            <?php endif; ?>                                                        
                        ...
                        <td>
                            <div class="btn-group">
                                <button type="button" data-color="<?php echo e($color); ?>" data-id="<?php echo e($host->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomedatacenter="<?php echo e($host->datacenter); ?>" class="edit_host fas fa-edit" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar HOST"></button>
                                <button type="button" data-id="<?php echo e($host->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomedatacenter="<?php echo e($host->datacenter); ?>" class="delete_host_btn fas fa-trash" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir HOST"></button>
                            </div>
                        </td>
                    </tr>
...
$(document).ready(function(){
        ...
        $(document).on('click','.delete_host_btn',function(e){
            ...
            Swal.fire({
             ...
             if(result.isConfirmed){                                     
                    $.ajax({
                        url:'/datacenteradmin/host/delete-host/'+id,
                        type:'POST',                    
                        dataType:'json',
                        data:{
                            'id':id,
        ...
        $(document).on('click','.update_host',function(e){
            ...
            $.ajax({
                ...
                data:data,
                dataType:'json',
                url:'/datacenteradmin/host/update-host/'+id,
                success:function(response){
                    if(response.status==400){
                        ...
                        var limita1 = '<tr id="host'+response.host.id+'">\
                            ...
                            limita5 = '<td>\
                                <div class="btn-group">\
                                    <button type="button" data-color="'+strcolor+'" data-id="'+response.host.id+'" data-admin="'+response.user.admin+'" data-nomedatacenter="'+response.host.datacenter+'" class="edit_host fas fa-edit" style="background: transparent;border: none;"></button>\
                                    <button type="button" data-id="'+response.host.id+'" data-admin="'+response.user.admin+'" data-nomedatacenter="'+response.host.datacenter+'" class="delete_host_btn fas fa-trash" style="background: transparent;border: none;"></button>\
                                </div>\
                            </td>\
                        </tr>';
        ...
        $(document).on('click','.add_host',function(e){
            ...
            $.ajax({
                url:'/datacenteradmin/host/adiciona-host',
                type:'POST',
                dataType:'json',
                data: data,
                success:function(response){                
        ...
        $(document).on('click','.cadsenha_btn',function(e){
         ...
         $(document).on('click','.add_senhahost_btn',function(e){
            ...
            $.ajax({                
                ...
                data:data,
                dataType: 'json',
                url:'/datacenteradmin/host/storesenhahost/'+id,
                success:function(response){
                      if(response.status==400){
                           //erros
                            $("#saveformsenha_errList").replaceWith('<ul id="saveformsenha_errList"></ul>');
    ...
    $(document).on('click','.senhabloqueada_btn',function(e){
        ...
        $.ajax({
            type: 'GET',
            dataType: 'json',
            url: '/datacenteradmin/host/editsenhahost/'+id,
            success: function(response){
                if(response.status==200){                                                       
    ...
    $(document).on('click','.update_senhahost_btn',function(e){
            ...
            $.ajax({                
                ...
                data:data,
                dataType: 'json',
                url:'/datacenteradmin/host/updatesenhahost/'+id,
                success:function(response){
                      if(response.status==400){
                           //erros
                            $("#updateformsenha_errList").replaceWith('<ul id="updateformsenha_errList"></ul>');
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/datacenter/host/index.blade.php ENDPATH**/ ?>