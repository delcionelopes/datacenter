...
<body>   
   ...
   <nav>
    ...
    <h3 style="text-align: center; text-decoration-style: solid">RELATÓRIO DE SETORES</h3>
    </nav>    
    <div>    
    </div>    
    ...
    <thead>        
        <tr>
            <th scope="row" style="text-align: justify">SIGLA</th>
    ...
    <tbody>
           ...
           <?php echo e($linha=0); ?>
            ...
            <tr>
                ...
                <?php if($setor->created_at==null): ?>
                <td></td>
                <?php else: ?>
                <td><?php echo e(date('d/m/Y H:i:s',strtotime($setor->created_at))); ?></td>
                <?php endif; ?>
                <?php if($setor->updated_at==null): ?>
                <td></td>
                <?php else: ?>
                <td><?php echo e(date('d/m/Y H:i:s',strtotime($setor->updated_at))); ?></td>
                <?php endif; ?>
            </tr>
            <?php echo e($linha++); ?>
...
</html><?php /**PATH C:\xampp\php\datacenter\resources\views/relatorios/datacenter/setores.blade.php ENDPATH**/ ?>