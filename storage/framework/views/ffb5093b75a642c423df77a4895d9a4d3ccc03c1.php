...
<body>   
   ...
   <nav>
    ...
    <h3 style="text-align: center; text-decoration-style: solid">RELATÓRIO DE PERMISSÕES PARA <?php echo e($perfil->nome); ?></h3>    
    </nav>    
    <div>    
    </div>    
    ...
    <tbody>           
         <?php $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
            ...
            <tr>
                <td style="font-weight: bold;"><span>&#8226;</span>&nbsp;<?php echo e($mod->nome); ?></td>
                <?php if($aut->created_at==null): ?>
                <td></td>
                <?php else: ?>
                <td style="font-weight: bold;"><?php echo e(date('d/m/Y H:i:s',strtotime($aut->created_at))); ?></td>
                <?php endif; ?>
                <td style="font-weight: bold;"><?php echo e($aut->usercreater->cpf); ?></td>
                <?php $__currentLoopData = $operacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ope): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $aut2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autindiv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(($autindiv->modulo_has_operacao_operacao_id == $ope->id)&&($autindiv->modulo_has_operacao_modulo_id == $mod->id)): ?>                
                <tr>
                <td>&nbsp;&nbsp;<?php echo e($ope->nome); ?></td>
                <td></td>
                <td></td>
                </tr>                
                <?php break; ?>
...
</html><?php /**PATH C:\xampp\php\datacenter\resources\views/relatorios/datacenter/autorizacao.blade.php ENDPATH**/ ?>