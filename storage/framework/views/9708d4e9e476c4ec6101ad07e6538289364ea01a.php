...
<div class="container-fluid py-5">   
    ...
    <form action="<?php echo e(route('datacenteradmin.operacao.index')); ?>" class="form-search" method="GET">
        <div class="col-sm-12">
            ...
            <a href="<?php echo e(route('datacenteradmin.operacao.create')); ?>" type="button" class="AddModuloModal_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none;white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro"><i class="fas fa-plus"></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/caos/operacao/index_operacaoXmodulos.blade.php ENDPATH**/ ?>