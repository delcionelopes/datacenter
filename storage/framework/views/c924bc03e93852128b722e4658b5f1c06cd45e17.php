...
<head>
    ...
    <title>Relatório de Clusters</title>  
...
<body>   
   ...
   <nav>
    ...
    <h3 style="text-align: center; text-decoration-style: solid">RELATÓRIO DE CLUSTERS</h3>
    </nav>    
    <div>    
    </div>    
    ...
    <thead>        
        <tr>
            ...
            <th scope="row" style="text-align: justify">CPU</th>
            <th scope="row" style="text-align: justify">MEM</th>
    ...
    <tbody>
           ...
           <?php echo e($linha=0); ?>
            ...
            <tr>
                <td><?php echo e($cluster->nome_cluster); ?></td>
                <td><?php echo e($cluster->total_processador); ?></td>
                <td><?php echo e($cluster->total_memoria); ?></td>
                <?php if($cluster->created_at==null): ?>
                <td> </td>
                <?php else: ?>
                <td><?php echo e(date('d/m/Y H:i:s',strtotime($cluster->created_at))); ?></td>
                <?php endif; ?>
                <?php if($cluster->updated_at==null): ?>
                <td> </td>
                <?php else: ?>
                <td><?php echo e(date('d/m/Y H:i:s',strtotime($cluster->updated_at))); ?></td>
                <?php endif; ?>
            </tr>
            <?php echo e($linha++); ?>
...
</html><?php /**PATH C:\xampp\php\datacenter\resources\views/relatorios/datacenter/clusters.blade.php ENDPATH**/ ?>