    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                <form id="editform" name="editfom" class="form-horizontal" role="form" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="edit_name" class="name form-control" value="<?php echo e($user->name); ?>">
                    </div>
                    <div class="form-group mb-3">
                        <label for="">e-Mail</label>
                        <input type="text" id="edit_email" class="email form-control" value="<?php echo e($user->email); ?>">
                    </div>                    
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="edit_link_instagram" class="link_instagram form-control" value="<?php echo e($user->link_instagram); ?>">
                    </div>                                        
                    <div class="form-group mb-3">
                        <label for="">URL Facebook</label>
                        <input type="text" id="edit_link_facebook" class="link_facebook form-control" value="<?php echo e($user->link_facebook); ?>">
                    </div>                                      
                    <div class="form-group mb-3">
                        <label for="">URL Site</label>
                        <input type="text" id="edit_link_site" class="link_site form-control" value="<?php echo e($user->link_site); ?>">
                    </div> 
                     <!--arquivo de imagem-->
                    <div class="form-group mb-3">                                                
            ...
            <div class="modal-footer">
                <a href="<?php echo e(route('page.master')); ?>" type="button" class="btn btn-default">Fechar</a>
...
<?php echo $__env->make('layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/page/perfil.blade.php ENDPATH**/ ?>