    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_vlan"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="AddRedeModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_rede"><img id="imgaddrede" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditVlanModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_vlan"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
            </div>
        </div>
    </div>
</div>
   ...
   <div class="modal fade animate__animated animate__bounce animate__faster" id="AddSenhaVLAN" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_senhavlan_btn"><img id="imgaddsenha" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditSenhaVLAN" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_senhavlan_btn"><img id="imgeditsenha" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5"> 
    ...
    <form action="<?php echo e(route('datacenteradmin.vlan.vlan.index',['color'=>$color])); ?>" class="form-search" method="GET">
        <div class="col-sm-12">
            ...
            <button type="button" data-setoradmin="<?php echo e(auth()->user()->setor_idsetor); ?>" class="AddVlanModal_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro"><i class="fas fa-plus"></i></button>
            ...
            <div class="row">
                <div class="col-12"> 
                    ...
                    <thead class="bg-<?php echo e($color); ?>" style="color: white">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $vlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vlan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>   
                            <tr id="vlan<?php echo e($vlan->id); ?>">                                
                                <th scope="row"><?php echo e($vlan->nome_vlan); ?></th>
                                 <td id="senha<?php echo e($vlan->id); ?>">
                                    <?php if(!$vlan->senha): ?>
                                    <button id="botaosenha<?php echo e($vlan->id); ?>" type="button" data-id="<?php echo e($vlan->id); ?>" data-nomevlan="<?php echo e($vlan->nome_vlan); ?>" class="cadsenha_btn fas fa-folder" style="background: transparent; color: orange; border: none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Registrar senha e dar<br>permissões de visualização"></button>
                                    <?php else: ?>
                                    <?php if($vlan->users()->count()): ?>                           
                                    <?php $__currentLoopData = $vlan->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <button id="botaosenha<?php echo e($vlan->id); ?>" type="button" data-id="<?php echo e($vlan->id); ?>" data-nomevlan="<?php echo e($vlan->nome_vlan); ?>" data-opt="1" class="senhabloqueada_btn fas fa-lock-open" style="background: transparent; color: green; border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($vlan->users->implode('name','<br>')); ?>"></button>
                                        <?php break; ?>
                                        <?php elseif($loop->last): ?>
                                        <button id="botaosenha<?php echo e($vlan->id); ?>" type="button" data-id="<?php echo e($vlan->id); ?>" data-nomevlan="<?php echo e($vlan->nome_vlan); ?>" data-opt="0" class="senhabloqueada_btn fas fa-lock" style="background: transparent; color: red; border: none;white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($vlan->users->implode('name','<br>')); ?>"></button>
                                        <?php endif; ?>                                                        
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                            
                                    <?php endif; ?>
                                    <?php endif; ?>                                                        
                                ...
                                <td>
                                    <?php if($vlan->redes()->count()): ?>
                                    <form action="<?php echo e(route('datacenteradmin.rede.rede.index',['id' => $vlan->id,'color'=>$color])); ?>" method="get">
                                        <button type="submit" data-id="<?php echo e($vlan->id); ?>" class="list_rede_btn fas fa-network-wired" style="background: transparent;border:none;color:green; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Lista REDE(s)"> <?php echo e($vlan->redes()->count()); ?></button>
                                    </form>
                                    <?php else: ?>
                                        <button type="button" data-id="<?php echo e($vlan->id); ?>" class="nova_rede_btn fas fa-folder" style="background: transparent;border:none;color:orange; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Cadastra nova REDE"></button>
                                    <?php endif; ?>    
                                </td>                               
                                <td>                                    
                                        <div class="btn-group">                                           
                                            <button type="button" data-id="<?php echo e($vlan->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" class="edit_vlan fas fa-edit" style="background:transparent;border:none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar VLAN"></button>
                                            <button type="button" data-id="<?php echo e($vlan->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomevlan="<?php echo e($vlan->nome_vlan); ?>" class="delete_vlan_btn fas fa-trash" style="background:transparent;border:none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir VLAN"></button>
                                        </div>                                    
                                </td>
                            </tr>  
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/datacenter/vlan/index.blade.php ENDPATH**/ ?>