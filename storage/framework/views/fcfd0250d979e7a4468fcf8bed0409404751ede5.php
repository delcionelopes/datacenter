        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_plataforma"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_plataforma"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5">
    <div id="success_message"></div>
            <section class="border p-4 mb-4 d-flex align-items-left">
                <form action="<?php echo e(route('datacenteradmin.plataforma.plataforma.index',['color'=>$color])); ?>"  class="form-search" method="GET">
                    <div class="col-sm-12">
        ...
        <div class="container-fluid">
            ...
            <thead class="bg-<?php echo e($color); ?>" style="color: white">
                ...
                <tr id="novo" style="display:none;"></tr>
                    <?php $__empty_1 = true; $__currentLoopData = $plataformas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plataforma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr id="plataforma<?php echo e($plataforma->id); ?>">
                        <th scope="row"><?php echo e($plataforma->nome_plataforma); ?></th>                        
                        <td>
                            <div class="btn-group">
                                <button type="button" data-id="<?php echo e($plataforma->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomeplataforma="<?php echo e($plataforma->nome_plataforma); ?>" class="edit_plataforma fas fa-edit" style="background: transparent; border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar"></button>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/plataforma/index.blade.php ENDPATH**/ ?>