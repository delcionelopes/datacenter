    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_base_btn"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditBaseModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_base_btn"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="AddAppModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                ...
                <form id="addappform" name="addappform" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <select name="add_selbase_id" id="add_selbase_id" class="custom-select">
                            <?php $__currentLoopData = $bds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $base): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_app_btn"><img id="imgaddapp" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
   ...
   <div class="modal fade animate__animated animate__bounce animate__faster" id="AddSenhaBase" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_senhabase_btn"><img id="imgaddsenha" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="EditSenhaBase" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_senhabase_btn"><img id="imgeditsenha" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5">
    <div id="success_message"></div>        
            ...
            <form action="<?php echo e(route('datacenteradmin.base.base.index',['id'=>$id,'color'=>$color])); ?>" class="form-search" method="GET">
                    <div class="col-sm-12">
                        <div class="input-group rounded">
                        <nav class="navbar navbar-expand-md navbar-light bg-light">
                            <input type="hidden" id="vmid" value="<?php echo e($id); ?>">  
        ...
        <div class="container-fluid">
            ...
            <thead class="bg-<?php echo e($color); ?>" style="color: white">
                ...
                <tbody id="lista_bases">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $bases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $base): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr id="base<?php echo e($base->id); ?>" data-toggle="tooltip" title="<?php echo e($base->ip); ?>">                        
                        <th scope="row"><?php echo e($base->nome_base); ?></th>
                        <td id="senha<?php echo e($base->id); ?>">
                            <?php if(!$base->senha): ?>
                            <button id="botaosenha<?php echo e($base->id); ?>" type="button" data-id="<?php echo e($base->id); ?>" data-nomebase="<?php echo e($base->nome_base); ?>" data-ip="<?php echo e($base->ip); ?>" class="cadsenha_btn fas fa-folder" style="background: transparent; color: orange; border: none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Registrar senha e dar<br>permissões de visualização"></button>
                            <?php else: ?>
                            <?php if($base->users()->count()): ?>                           
                            <?php $__currentLoopData = $base->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <button id="botaosenha<?php echo e($base->id); ?>" type="button" data-id="<?php echo e($base->id); ?>" data-nomebase="<?php echo e($base->nome_base); ?>" data-ip="<?php echo e($base->ip); ?>" data-opt="1" class="senhabloqueada_btn fas fa-lock-open" style="background: transparent; color: green; border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($base->users->implode('name','<br>')); ?>"></button>
                                  <?php break; ?>
                                  <?php elseif($loop->last): ?>
                                  <button id="botaosenha<?php echo e($base->id); ?>" type="button" data-id="<?php echo e($base->id); ?>" data-nomebase="<?php echo e($base->nome_base); ?>" data-ip="<?php echo e($base->ip); ?>" data-opt="0" class="senhabloqueada_btn fas fa-lock" style="background: transparent; color: red; border: none;white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="<?php echo e($base->users->implode('name','<br>')); ?>"></button>
                                  <?php endif; ?>                                                        
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                            
                            <?php endif; ?>
                            <?php endif; ?>                                                        
                        ...
                        <td>
                        <div class="btn-group">
                        <?php if($base->apps->count()): ?>
                        <form action="<?php echo e(route('datacenteradmin.app.app.index',['id'=>$base->id,'color'=>$color])); ?>" method="get">
                            <button type="submit" data-id="<?php echo e($base->id); ?>" class="list_app_btn fas fa-desktop" style="background: transparent;border:none;color: green; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Menu de APPs para <?php echo e($base->nome_base); ?>"> <?php echo e($base->apps->count()); ?></button>
                        </form>
                        <?php else: ?>
                        <button type="button" data-id="<?php echo e($base->id); ?>" data-nome_base="<?php echo e($base->nome_base); ?>" class="novo_app_btn fas fa-folder" style="background: transparent;border:none;color: orange; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Cadastro de APPs"></button>
                        <?php endif; ?>
                        </div>
                        </td>                        
                        <td>
                            <div class="btn-group">
                                <button type="button" data-color="<?php echo e($color); ?>" data-id="<?php echo e($base->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomebase="<?php echo e($base->nome_base); ?>" class="edit_base_btn fas fa-edit" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar <?php echo e($base->nome_base); ?>"></button>
                                <button type="button" data-id="<?php echo e($base->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomebase="<?php echo e($base->nome_base); ?>" class="delete_base_btn fas fa-trash" style="background: transparent;border: none;white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir <?php echo e($base->nome_base); ?>"></button>
                            </div>
                        </td>
                    </tr>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/datacenter/base/index.blade.php ENDPATH**/ ?>