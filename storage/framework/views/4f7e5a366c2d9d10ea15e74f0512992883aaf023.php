   ...
   <nav>
    ...
    <tbody>
           ...
           <?php echo e($linha=0); ?>
            ...
            <tr>
                <td><?php echo e($rede->nome_rede); ?></td>
                <td><?php echo e($rede->tipo_rede); ?></td>
                <td><?php echo e($rede->vlan->nome_vlan); ?></td>
                <?php if($rede->created_at==null): ?>
                <td></td>
                <?php else: ?>
                <td><?php echo e(date('d/m/Y H:i:s',strtotime($rede->created_at))); ?></td>
                <?php endif; ?>
                <?php if($rede->updated_at==null): ?>
                <td></td>
                <?php else: ?>
                <td><?php echo e(date('d/m/Y H:i:s',strtotime($rede->updated_at))); ?></td>
                <?php endif; ?>
            </tr>
            <?php echo e($linha++); ?>
...
</html><?php /**PATH C:\xampp\php\datacenter\resources\views/relatorios/datacenter/redes.blade.php ENDPATH**/ ?>