        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-<?php echo e($color); ?> add_manual_btn"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    <button type="button" class="btn btn-<?php echo e($color); ?> update_manual"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    <button type="submit" class="btn btn-<?php echo e($color); ?> upload_manual"><img id="imgenviar" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Enviar</button>
                </div>
                </form>
            </div>
        </div>
...
<div class="container-fluid py-5">
    <div id="success_message"></div>
            <section class="border p-4 mb-4 d-flex align-items-left">
                <form action="<?php echo e(route('datacenteradmin.manual.manual.index',['color'=>$color])); ?>" class="form-search" method="GET">                                      
                    <div class="col-sm-12">
        ...
        <div class="container-fluid">
            ...
            <thead class="bg-<?php echo e($color); ?>" style="color: white">
                ...
                <tr id="novo" style="display:none;"></tr>                  
                    ...
                    <tr id="man<?php echo e($manual->id); ?>" data-toggle="tooltip" title="<?php echo e($manual->objetivo); ?>">
                        <th scope="row"><?php echo e($manual->descricao); ?></th>                        
                        <td><?php echo e($manual->area_conhecimento->descricao); ?></td>
                        <td id="uploads<?php echo e($manual->id); ?>">
                        <label id="files<?php echo e($manual->id); ?>">Files: <?php echo e($manual->uploads->count()); ?> </label><button type="button" id="upload_files_btn" data-manualid="<?php echo e($manual->id); ?>" data-idsetor="<?php echo e($manual->setor_idsetor); ?>" class="upload_files_btn fas fa-file-pdf" style="background: transparent;border: none;white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Enviar ARQUIVOS"></button>    
                        <ul id="listaarquivos<?php echo e($manual->id); ?>" style="list-style: none;">
                        <?php if($manual->uploads->count()): ?>    
                            <?php $__currentLoopData = $manual->uploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upload): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                        
                            <li id="up<?php echo e($upload->id); ?>">
                                <i data-filename="<?php echo e($upload->nome_arquivo); ?>" data-id="<?php echo e($upload->id); ?>" class="download_file_btn fas fa-download"></i>
                                <i data-filename="<?php echo e($upload->nome_arquivo); ?>" data-id="<?php echo e($upload->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-idsetor="<?php echo e($manual->setor_idsetor); ?>" class="delete_file_btn fas fa-trash"></i></li>
                                <iframe id="viewer<?php echo e($upload->id); ?>" src="<?php echo e(asset('storage/ViewerJS/#../'.$upload->path_arquivo)); ?>" width="400" height="300" allowfullscreen webkitallowfullscreen></iframe>
                            <br>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>    
                        </ul>
                        ...
                        <td>
                            <div class="btn-group">
                                <button data-id="<?php echo e($manual->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-idsetor="<?php echo e($manual->setor_idsetor); ?>" data-descricao="<?php echo e($manual->descricao); ?>" class="edit_manual_btn fas fa-edit" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar"></button>
                                <button data-id="<?php echo e($manual->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-idsetor="<?php echo e($manual->setor_idsetor); ?>" data-descricao="<?php echo e($manual->descricao); ?>" class="delete_manual_btn fas fa-trash" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir"></button>
                            </div>
                        </td>
                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/manuais/index.blade.php ENDPATH**/ ?>