...
<div class="modal fade animate__animated animate__bounce animate__faster" id="SelPerfilModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header navbar-dark bg-<?php echo e($color); ?>" id="titulo_selusermodal">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-<?php echo e($color); ?> btnselusuario"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Visualizar</button>
            </div>
        </div>
    </div>
</div>
...
<?php $__currentLoopData = $operacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ope): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
  ...
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="<?php echo e(asset('storage/'.$ope->ico)); ?>" class="card-img" alt="<?php echo e($ope->nome); ?>">
      </a>
    </div>
    <div class="col-md-8">
...
$(document).ready(function(){
  ...
  $(document).on('click','.abrir',function(e){    //aciona pelos elementos img pelo link e pelo button abrir_btn através do atributo comum class .abrir
    ...
    var linkgif = "<?php echo e(asset('storage/ajax-loader.gif')); ?>";
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/caos/secondary/index.blade.php ENDPATH**/ ?>