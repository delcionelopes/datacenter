    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> add_ambiente"><img id="imgadd" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Salvar</button>
            </div>
        </div>
    </div>
...
<div class="modal fade animate__animated animate__bounce animate__faster" id="editAmbienteModal" tabindex="-1" role="dialog" aria-labelledby="titleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button type="button" data-color="<?php echo e($color); ?>" class="btn btn-<?php echo e($color); ?> update_ambiente"><img id="imgedit" src="<?php echo e(asset('storage/ajax-loader.gif')); ?>" style="display: none;" class="rounded-circle" width="20"> Atualizar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5">   
    ...
    <form action="<?php echo e(route('datacenteradmin.ambiente.ambiente.index',['color'=>$color])); ?>" class="form-search" method="GET">
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <thead class="bg-<?php echo e($color); ?>" style="color: white">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $ambientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ambiente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>   
                            <tr id="ambiente<?php echo e($ambiente->id); ?>">                                
                                <th scope="row"><?php echo e($ambiente->nome_ambiente); ?></th>                                
                                <td>                                    
                                        <div class="btn-group">                                           
                                            <button type="button" data-id="<?php echo e($ambiente->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomeambiente="<?php echo e($ambiente->nome_ambiente); ?>" class="edit_ambiente fas fa-edit" style="background:transparent;border:none; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar AMBIENTE"></button>
                                            <button type="button" data-id="<?php echo e($ambiente->id); ?>" data-admin="<?php echo e(auth()->user()->admin); ?>" data-nomeambiente="<?php echo e($ambiente->nome_ambiente); ?>" class="delete_ambiente_btn fas fa-trash" style="background:transparent;border:none; white-space: nowrap;" data-html="true" data-placement="right" data-toggle="popover" title="Excluir AMBIENTE"></button>
                                        </div>                                    
                                </td>
                            </tr>  
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\php\datacenter\resources\views/ambientes/index.blade.php ENDPATH**/ ?>