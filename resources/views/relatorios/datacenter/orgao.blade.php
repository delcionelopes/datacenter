...
<head>
    ...
    <title>Relatório de Órgãos</title>  
...
<body>   
   ...
   <nav>
    ...
    <h3 style="text-align: center; text-decoration-style: solid">RELATÓRIO DE ORGÃOS</h3>
    </nav>    
    <div>    
    </div>    
    ...
    <thead>        
        <tr>
            ...
            <th scope="row" style="text-align: justify">TELEFONE</th>
