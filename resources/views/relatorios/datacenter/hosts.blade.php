...
<head>
    ...
    <title>Relatório de Hosts</title>  
...
<body>   
   ...
   <nav>
    ...
    <h3 style="text-align: center; text-decoration-style: solid">RELATÓRIO DE HOSTS</h3>
    </nav>    
    <div>    
    </div>    
    ...
    <thead>        
        <tr>
            ...
            <th scope="row" style="text-align: justify">DATACENTER</th>
            <th scope="row" style="text-align: justify">CLUSTER</th>
        </tr>       
    </thead>
    <tbody>
           {{$pagina=1}}
           {{$linha=0}}
            ...
            <tr>
                ...
                <td>{{$host->clusterref->nome_cluster}}</td>
            </tr>
            {{$linha++}}
