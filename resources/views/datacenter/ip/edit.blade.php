                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="adorgao" id="adorgao" class="custom-select">
                                ...
                                <option class="optorgao" id="optorgao{{$orgao->id}}" data-id="{{$orgao->id}}" data-nome="{{$orgao->nome}}" value="{{$orgao->id}}" {{ old('orgao_vinc_id', $ip->orgao_vinc_id ?? '') === $orgao->id ? 'selected' : '' }}>{{$orgao->nome}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="adsetor" id="adsetor" class="custom-select">
                                ...
                                <option class="optsetor" id="optsetor{{$setor->id}}" data-id="{{$setor->id}}" data-descricao="{{$setor->descricao}}" value="{{$setor->id}}" {{ old('setor_vinc_id', $ip->setor_vinc_id ?? '') === $setor->id ? 'selected' : '' }}>{{$setor->descricao}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="addip" class="form-control" placeholder="000.000.000.000" data-mask="099.099.099.099" value="{{$ip->ip}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if($ip->status=='LIVRE')
                                <label for="" id="addstatus" style="color: green;"> {{$ip->status}}</label>
                                @else
                                <label for="" id="addstatus" style="color: red;"> {{$ip->status}}</label>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="addmac" class="form-control" placeholder="00:00:00:00:00:00" value="{{$ip->mac}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="descricao" id="adddescricao" class="form-control" cols="30" rows="10">{{$ip->descricao}}</textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>
