...
@section('title', 'PRODAP - Equipamentos')
...
<div class="container-fluid py-5">
    ...
    <div id="success_message"></div>        
            ...
            <form action="{{route('datacenteradmin.equipamento.equipamento.index',['id' => $grupo->id, 'color'=>$color])}}" class="form-search" method="GET">
                    <div class="col-sm-12">
                        ...
                        <nav class="navbar navbar-expand-md navbar-light bg-light">
                            ...
                            <button type="button" data-grupo="{{$grupo->id}}" data-color="{{$color}}" class="AddEquipamento_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none;white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro">
