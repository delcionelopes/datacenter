      ...
      <div class="card-body text-right">
        ...
        <button type="button" class="btn btn_primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-bars"></i></button>
         <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="" data-color="{{$color}}"> Editar</a></li>
            <li><a class="dropdown-item" href="" data-color="{{$color}}"> Excluir</a></li>
         </ul>   
        </div>
        </div>
        <p class="card-text">{{$grupo->descricao}}</p>        
        <a href="" class="btn btn-{{$color}}">Executar</a>
      </div>
    </div>
  </div>
  </div>
