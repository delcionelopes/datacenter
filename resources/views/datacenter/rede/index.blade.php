                ...
                <form action="{{route('datacenteradmin.rede.rede.index',['id'=>$id,'color'=>$color])}}" class="form-search" method="GET">
                    <div class="col-sm-12">
                        ...
                        <nav class="navbar navbar-expand-md navbar-light bg-light">
                            ...
                            <a href="{{route('datacenteradmin.vlan.vlan.index',['color'=>$color])}}" data-color="{{$color}}" type="button" class="voltarmenu_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none;"><i class="fas fa-door-open"></i></a>
                        </nav>
                        </div>
                    </div>
                </form>
