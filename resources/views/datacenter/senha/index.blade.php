...
<div class="container py-5"> 
            ...
            <div class="card p-3" style="background-image: url('/assets/img/home-bg.jpg')">
                ...
                <div class="ml-3 w-100">                    
                   ...
                   <div class="p-2 mt-2 bg-light d-flex rounded text-white stats halfOpacity">                    
                    @if($totaluserapps)
                    <div class="p-2 mt-2">
 ...
 <div class="row">
  ...
  <div class="p-2 mt-2">
    <div class="card" style="width: 10rem;">
      ...
      <div class="card-body">        
        <p class="card-text">Senha vencidas por BASEs. Total: {{$totalbases}}</p>        
  ...
  <div class="p-2 mt-2">
    <div class="card" style="width: 10rem;">
      ...
      <div class="card-body">        
        <p class="card-text">Senhas vencidas por V. Machine. Total: {{$totalvirtualmachines}}</p>        
        <a href="#" class="btn btn-danger">Ver VMs</a>        
      </div>
    </div>
  </div>
  @endif
  ...
  <div class="p-2 mt-2">
    <div class="card" style="width: 10rem;">
      ...
      <div class="card-body">        
        ...
        <a href="#" class="btn btn-danger">Ver VLANs</a>                
      </div>
    </div>
  </div>
  @endif
